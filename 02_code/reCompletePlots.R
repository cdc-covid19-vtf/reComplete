...
rePlot <- function(dataFrame, colName, imageID, imageTitle) {
  ...
  #federal entities 
  addSquare(name = "DC", inputData = fedEnts, xLoc = .90,
            yLoc = 0.40, jurID = "DCA")
  addSquare(name = "BoP", inputData = fedEnts, xLoc = .90,
            yLoc = 0.33, jurID = "BP2")
  addSquare(name = "DoD", inputData = fedEnts, xLoc = .90,
            yLoc = 0.26, jurID = "DD2")
  addSquare(name = "IHS", inputData = fedEnts, xLoc = .90,
            yLoc = 0.19, jurID = "IH2")
  addSquare(name = "VHA", inputData = fedEnts, xLoc = .90,
            yLoc = 0.12, jurID = "VA2")
  
  #state territories
  addSquare(name = "VI", inputData = territory, xLoc = .90, 
            yLoc = 0.05, jurID = "VIA")
  addSquare(name = "PW", inputData = territory, xLoc = 0.84, 
            yLoc = 0.05, jurID = "RPA")
  addSquare(name = "PR", inputData = territory, xLoc = 0.78, 
            yLoc = 0.05, jurID = "PRA")
  addSquare(name = "MP", inputData = territory, xLoc = 0.72, 
            yLoc = 0.05, jurID = "MPA")
  addSquare(name = "MH", inputData = territory, xLoc = 0.66, 
            yLoc = 0.05, jurID = "MHA")
  addSquare(name = "GU", inputData = territory, xLoc = 0.60, 
            yLoc = 0.05, jurID = "GUA")
  addSquare(name = "FM", inputData = territory, xLoc = 0.54, 
            yLoc = 0.05, jurID = "FMA")
  addSquare(name = "AS", inputData = territory, xLoc = 0.48, 
            yLoc = 0.05, jurID = "ASA")
